  ...
  USERS: [
    {
      ...
      useTemplateId: 'V-Hjt2XQADkcuzt6SBYMBd91crizlMtlG4MFbVbdDzY',
      // 所在省份或城市，也可以不填
      province: '北京',
      // 所在城市或县区
      city: '朝阳区',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '晓钰', year: '1994', date: '08-05',
        },
        {
          type: '节日', name: '在一起的纪念日', year: '2023', date: '10-21',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '玉溪', year: '1996', date: '09-31',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2023', date: '09-26',
        }
      ],
