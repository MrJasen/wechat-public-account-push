  ...
  USERS: [
    {
      ...
      id: 'oP7Yp6kY4WqBQrG4Z8nGw6gZRrW0',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: '9oCeuvMZfclKKvZGwx5UYNi5p4XUDGUSTFbsla1LiQ8',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '12-05',
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '佳鑫老婆', year: '2000', date: '11-10',
        },
        {
            type: '*生日', name: '玉溪老公', year: '1994', date: '04-04',
        },
